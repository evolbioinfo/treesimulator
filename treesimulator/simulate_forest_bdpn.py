...
def main():
    ...
    parser = \
        argparse.ArgumentParser(description="Simulates a tree (or a forest of trees) for given BD-PN model parameters. "
    ...
    model = PNModel(model=BirthDeathModel(p=params.p, la=params.la, psi=params.psi),
