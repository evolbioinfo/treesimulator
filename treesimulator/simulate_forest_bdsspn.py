...
def main():
    ...
    parser = \
        argparse.ArgumentParser(description="Simulates a tree (or a forest of trees) for given BDSS-PN model parameters. "
    ...
    model = PNModel(model=BirthDeathWithSuperSpreadingModel(p=params.p,
